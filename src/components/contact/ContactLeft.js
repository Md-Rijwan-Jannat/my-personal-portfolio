...
const ContactLeft = () => {
  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#0a0b0c] to-[#051320] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
